...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-001.png}
\begin{eulercomment}
Hitung luas ABC:
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  Function projectToLine needs a vector for A
  Error in:
...
segitiga ABC.\\
Titik singgung garis BC dengan linfkaran dalam
\end{eulercomment}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-005.png}
\begin{eulerprompt}
>K,L
\end{eulerprompt}
\begin{euleroutput}
...
\end{eulerprompt}
\begin{euleroutput}
  Variable or function Z not found.
  Error in:
  plotPoint(Z,"Z"); ...
             ^
\end{euleroutput}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-023.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-025.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-035.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-057.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-062.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-067.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-069.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-071.png}
\begin{eulerprompt}
...
>insimg(30);
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-078.png}
\begin{eulercomment}
Tentu saja,
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-091.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-121.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-126.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-131.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-135.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-136.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-137.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-138.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-139.png}
\begin{eulercomment}
\end{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-140.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-4,xmax=1,ymin=-2,ymax=2,hue=1,title="The minimum is on A");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-141.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-142.png}
\begin{eulerprompt}
>fcontour("d3",xmin=-2,xmax=2,ymin=-2,ymax=2,hue=1,title="The Fermat point");
>P=(A_B_C_A)'; plot2d(P[1],P[2],add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-143.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-144.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],points=1,add=1,color=12);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-145.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-146.png}
\begin{eulerprompt}
>fcontour("d4",xmin=-1.5,xmax=1.5,ymin=-1.5,ymax=1.5,hue=1);
>P=(A_B_C_D)'; plot2d(P[1],P[2],add=1,color=12,points=1);
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-147.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-148.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-152.png}
...
>povend();
\end{eulerprompt}
\eulerimg{28}{images/EMT4Geometry-153.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-154.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-155.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-156.png}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-157.png}
\begin{eulerprompt}
...
>plotCircle(c,"Lingkaran luar segitiga ABC"):
\end{eulerprompt}
\eulerimg{26}{images/EMT4Geometry-158.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-159.png}
\begin{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
sehingga didapatkan nilai a=-1, b=5, c=-4
\end{eulercomment}
\begin{eulerprompt}
>plot2d("-x^2+5*x-4",-5,5,-5,5):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-160.png}
\begin{eulercomment}
...
>aspect(1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-161.png}
\begin{eulerprompt}
...
>plotPoint(P,"P"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-162.png}
\begin{eulercomment}
Dari gambar di atas terlihat bahwa keempat garis bagi sudutnya bertemu
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-163.png}
\begin{eulercomment}
...
Penyelesaian:\\
Dietahuii kedua titik fokus P=[-1,-1] dan Q[1,-1]
\end{eulercomment}
\begin{eulerprompt}
>P=[-1,-1]; Q=[1,-1];
...
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-164.png}
\begin{eulercomment}
...
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-165.png}
\begin{eulercomment}
batasan ke garis PQ
\end{eulercomment}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-166.png}
\begin{eulercomment}
...
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-167.png}
\begin{eulerprompt}
>function d1(x,y):=sqrt((x-p[1])^2+(y-p[2])^2)
>Q=[1,-1]; function d2(x,y):=sqrt((x-P[1])^2+(y-P[2])^2)+sqrt((x+Q[1])^2+(y+Q[2])^2)
>fcontour("d2",xmin=-2,xmax=2,ymin=-3,ymax=1,hue=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-168.png}
\begin{eulercomment}
grafik yang lebih menarik
\end{eulercomment}
\begin{eulerprompt}
>plot3d("d2",xmin=-2,xmax=2,ymin=-3,ymax=1):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-169.png}
\begin{eulerprompt}
>plot2d("abs(x+1)+abs(x-1)",xmin=-3,xmax=3):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Geometry-170.png}
\end{eulernotebook}
\end{document}
