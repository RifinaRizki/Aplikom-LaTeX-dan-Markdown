...
\begin{euleroutput}
              ...
              2 
\end{euleroutput}
\eulerheading{Latihan 3}
\begin{eulercomment}
Soal 1\\
\end{eulercomment}
\eulerimg{6}{images/EMT00-FisrtSteps-005.png}
\begin{eulerprompt}
> 10^6 * 4^2 / 25^3 * 8^3
\end{eulerprompt}
\begin{euleroutput}
...
Soal 2\\
\end{eulercomment}
\eulerimg{4}{images/EMT00-FisrtSteps-006.png}
\begin{eulerprompt}
> s = 25; 6 * s^2
\end{eulerprompt}
\begin{euleroutput}
...
Soal 3\\
\end{eulercomment}
\eulerimg{5}{images/EMT00-FisrtSteps-007.png}
\begin{eulerprompt}
> 100 / 4 * 20
\end{eulerprompt}
\begin{euleroutput}
