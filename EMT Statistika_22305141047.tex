...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-001.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-003.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-005.png}
\eulerheading{Tabel}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-006.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-007.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-008.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-010.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-012.png}
\begin{eulerformula}
\[
\text{normaldis(x,m,d)}=\int_{-\infty}^x \frac{1}{d\sqrt{2\pi}}e^{-\frac{1}{2}(\frac{t-m}{d})^2}\ dt.
\]
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-015.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-016.png}
\begin{eulercomment}
...
>statplot(YT,BT1,"b"):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-018.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-020.png}
\begin{eulercomment}
...
>  angle=30°,ccols=CP):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-021.png}
\begin{eulercomment}
...
>shrinkwindow():
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-022.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-023.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-024.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-025.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-026.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-027.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-028.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-029.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-030.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-031.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-032.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-033.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-034.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  [6,  13,  28,  55,  55,  83,  108,  122,  145,  128,  101,  77,  46,
  22,  10,  1]
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-039.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-041.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-042.png}
\eulerheading{Tes}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-043.png}
\begin{eulerprompt}
>t=count(R,21);
\end{eulerprompt}
\begin{eulercomment}
...
\begin{eulercomment}
\begin{eulercomment}
\eulerheading{Beberapa Tes Lain}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-044.png}
\begin{eulercomment}
Hapus datanya.
\end{eulercomment}
\begin{eulerprompt}
...
>statplot(u,f,"h"):
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-045.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-047.png}
\eulerheading{Daftar}
\begin{eulercomment}
...
\begin{euleroutput}
  A,B,C
  0.7019620317345358,0.4563797157221827,0.1082572574735931
  0.5878371745190396,0.319352045722736,0.5492106525613486
  0.3389797181884181,0.7553828881157308,0.9153519216016462
...
\begin{euleroutput}
           A         B         C
     0.70196   0.45638   0.10826
     0.58784   0.31935   0.54921
     0.33898   0.75538   0.91535
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  0.9763598539822677,0.8960883422603407,0.4499922014071313
  0.3637017518815812,0.9783964600244999,0.08196288159435845
  0.3279044562354119,0.2947083278792947,0.2979809778409
...
\end{eulerprompt}
\begin{euleroutput}
    0.97636   0.89609   0.44999 
     0.3637    0.9784  0.081963 
     0.3279   0.29471   0.29798 
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{15}{images/EMT4Statistika-048.png}
\begin{eulercomment}
...
\begin{euleroutput}
  M = [ ..
  0.4115767492838314, 0.8578411610408214;
  0.9377293985835271, 0.2645823967128544];
\end{euleroutput}
\begin{eulercomment}
...
\end{eulerprompt}
\begin{euleroutput}
  [0.7584,  0.64002,  0.45605,  0.1221,  0.87526]
\end{euleroutput}
\eulerheading{Latihan Soal}
\begin{eulercomment}
\end{eulercomment}
\eulersubheading{Soal No 1 }
\begin{eulercomment}
Data nilai ulangan harian matematika SD Mathfun sebagai berikut:\\
85,85,90,85,85,75,90, dan 95\\
Rata-rata nilai ualangan harian tersebut adalah .....

Penyelesaian:
\end{eulercomment}
\begin{eulerprompt}
>x=[85,85,90,85,85,75,90,95]; mean(x)
\end{eulerprompt}
\begin{euleroutput}
  86.25
\end{euleroutput}
\begin{eulercomment}
Jadi, rata-rata dari data tersebut adalah 86.25
\end{eulercomment}
\begin{eulercomment}

\end{eulercomment}
\eulersubheading{Soal No 2}
\begin{eulercomment}
Data upah dari 10 karyawan yang dinyatakan dalam rupiah adalah sebagai
berikut:\\
800,750,900,800,850,850,900,700,700,750\\
Tentukan nilai median dari data tersebut!

Penyelesaian:
\end{eulercomment}
\begin{eulerprompt}
>data=[800,750,900,800,850,850,900,700,700,750];
>urut=sort(data)
\end{eulerprompt}
\begin{euleroutput}
...
\end{euleroutput}
\begin{eulercomment}
Jadi, median dari data tersebut adalah 800
\end{eulercomment}
\begin{eulercomment}

\end{eulercomment}
\eulersubheading{Soal No 3}
\begin{eulercomment}
Diketahui berat badan balita di Desa Moonlight sebagai berikut:\\
10,13,14,10,12,12,12,15,14,16,13,14,12,14,15\\
Tentukan Q1, Q2, dan Q3!

Penyelesaian:
\end{eulercomment}
\begin{eulerprompt}
>data=[10,13,14,10,12,12,12,15,14,16,13,14,12,14,15];
>urut=sort(data)
\end{eulerprompt}
\begin{euleroutput}
  [10,  10,  12,  12,  12,  12,  13,  13,  14,  14,  14,  14,  15,  15,
  16]
\end{euleroutput}
\begin{eulerprompt}
>a=length(data)
...
\end{euleroutput}
\begin{eulercomment}
Jadi, kuartil dari data tersebut sebagai berikut:\\
Q1 = letak kuartil data ke-1 ada di data nomor 4 yaitu 12\\
Q2 = letak kuartil data ke-2 ada di data nomor 8 yaitu 13\\
Q3 = letak kuartil data ke-3 ada di data nomor 12 yaitu 14


\end{eulercomment}
\eulersubheading{Soal No 4}
\begin{eulercomment}
Tentukan desil ke-7 dari data berikut:\\
3,4,6,7,7,9,10,10,10,3,2,2,2,2,4,,7,9,8,5,3,1,4,6,7,6,6,12,13,13,14,16

Penyelesaian:
\end{eulercomment}
\begin{eulerprompt}
>data=[3,4,6,7,7,9,10,10,10,3,2,2,2,2,4,7,9,8,5,3,1,4,6,7,6,6,12,13,13,14,16];
>urut=sort(data)
\end{eulerprompt}
\begin{euleroutput}
  [1,  2,  2,  2,  2,  3,  3,  3,  4,  4,  4,  5,  6,  6,  6,  6,  7,  7,
  7,  7,  8,  9,  9,  10,  10,  10,  12,  13,  13,  14,  16]
\end{euleroutput}
\begin{eulerprompt}
>quantile(urut,0.5)
\end{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Jadi, nilai persentil ke-50 data tersebut adalah 6

\end{eulercomment}
\eulersubheading{Soal No 5}
\begin{eulercomment}
Tentukan jangkauan dari data berikut!\\
65,60,65,70,80,85,85,80,90,65,55,45,30,60,90,85,95,45,40

Penyelesaian:
\end{eulercomment}
\begin{eulerprompt}
>data=[65,60,65,70,80,85,85,80,90,65,55,45,30,60,90,85,95,45,40];
>a=max(data)
\end{eulerprompt}
\begin{euleroutput}
  95
...
\end{euleroutput}
\begin{eulercomment}
Jadi, jangkauan data tersebut adalah 65

\end{eulercomment}
\eulersubheading{Soal No 6}
\begin{eulercomment}
Disajikan data sebagai berikut:\\
100,135,160,130,125,110,115,180,140,150\\
Tentukan varians dari data tersebut!

Penyelesaian:
\end{eulercomment}
\begin{eulerprompt}
>data=[100,135,160,130,125,110,115,180,140,150];
>urut=sort(data)
\end{eulerprompt}
\begin{euleroutput}
  [100,  110,  115,  125,  130,  135,  140,  150,  160,  180]
\end{euleroutput}
\begin{eulerprompt}
>a=mean(urut)
\end{eulerprompt}
...
\end{eulerprompt}
\begin{euleroutput}
  [-34.5,  -24.5,  -19.5,  -9.5,  -4.5,  0.5,  5.5,  15.5,  25.5,  45.5]
\end{euleroutput}
\begin{eulerprompt}
>varians=mean(dev^2)
\end{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Jadi, varians dari data tersebut adalah 527,25

\end{eulercomment}
\eulersubheading{Soal No 7}
\begin{eulercomment}
Tentukan simpangan baku dari data berikut!\\
300,200,300,300,250,350,250,400,500,550

Penyelesaian:
\end{eulercomment}
\begin{eulerprompt}
>data=[300,200,300,300,250,350,250,400,500,550];
>urut=sort(data)
\end{eulerprompt}
\begin{euleroutput}
  [200,  250,  250,  300,  300,  300,  350,  400,  500,  550]
\end{euleroutput}
\begin{eulerprompt}
>a=mean(urut)
\end{eulerprompt}
...
\end{eulerprompt}
\begin{euleroutput}
  [-140,  -90,  -90,  -40,  -40,  -40,  10,  60,  160,  210]
\end{euleroutput}
\begin{eulerprompt}
>varians=mean(dev^2)
\end{eulerprompt}
...
\end{euleroutput}
\begin{eulercomment}
Jadi, nilai simpangan baku dari data tersebut adalah 106.77078252

\end{eulercomment}
\eulersubheading{Soal  No 8}
\begin{eulercomment}
Tentukan rata-rata dari data berikut!\\
1110,1220,1130,1115,1126,1130,1138,1140,1150,1200

Penyelesaian:
\end{eulercomment}
\begin{eulerprompt}
>data=[1110,1220,1130,1115,1126,1130,1138,1140,1150,1200]
\end{eulerprompt}
\begin{euleroutput}
  [1110,  1220,  1130,  1115,  1126,  1130,  1138,  1140,  1150,  1200]
\end{euleroutput}
...
\begin{euleroutput}
  1145.9
  155,160,160,175,155,155,160,165,160165,150,170,150,
  155,160,170,155,155,155,155,160,145,155,170,175
\end{euleroutput}
\begin{eulercomment}
Jadi, rata-rata  dari data tersebut adalah 1145.9

\end{eulercomment}
\eulersubheading{Soal No 9}
\begin{eulercomment}
Diketahui data tinggi badan siswa SMA Greenblue sebagai berikut:\\
155,160,160,175,155,155,160,165,160165,150,170,150,\\
155,160,170,155,155,155,155,160,145,155,170,175\\
...
\end{eulercomment}
\begin{eulerprompt}
>data=[155,160,160,175,155,155,160,165,160,165,150,170,150,155,160,170,155,155,155,155,160,145,155,170,175];
>urut=sort(data)
\end{eulerprompt}
\begin{euleroutput}
  [145,  150,  150,  155,  155,  155,  155,  155,  155,  155,  155,  155,
  160,  160,  160,  160,  160,  160,  165,  165,  170,  170,  170,  175,
  175]
\end{euleroutput}
\begin{eulerprompt}
>median(data)
...
\end{euleroutput}
\begin{eulercomment}
Jadi, median dari data tersebut adalah 160

\end{eulercomment}
\eulersubheading{Soal No 10}
\begin{eulercomment}
Tentukan Q1,Q2,Q3 dari data berikut!\\
35,57,93,59,79,23,145,53,169,113,114,115,178,198,176

Penyelesaian:
\end{eulercomment}
\begin{eulerprompt}
>data=[35,57,93,59,79,23,145,53,169,113,114,115,178,198,176];
>urut=sort(data)
\end{eulerprompt}
\begin{euleroutput}
  [23,  35,  53,  57,  59,  79,  93,  113,  114,  115,  145,  169,  176,
  178,  198]
\end{euleroutput}
\begin{eulerprompt}
>a=length(data)
...
\begin{eulercomment}
Jadi, kuartil dari data tersebut sebagai berikut:\\
Q1 = letak kuartil data ke-1 ada di data nomor 4 yaitu 57\\
Q2 = letak kuartil data ke-2 ada di data nomor 8 yaitu 113\\
Q3 = letak kuartil data ke-3 ada di data nomor 12 yaitu 169
\end{eulercomment}
\end{eulernotebook}
\end{document}
