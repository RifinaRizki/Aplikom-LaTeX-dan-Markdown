...
\begin{eulercomment}
Notebook ini menjelaskan tentang cara menggambar berbagai macam kurva
dan grafik 2D dengan software EMT. EMT menyediakan fungsi plot2d()
untuk menggambar berbagai kurva dan grafik dua dimensi (2D).\\
\end{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-001.png}
\begin{eulerprompt}
>reset;
\end{eulerprompt}
\begin{eulercomment}
...
>plot2d("x^4-x",grid=6):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-002.png}
\begin{eulerprompt}
>hold off;
>window(ow);
\end{eulerprompt}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-003.png}
\begin{eulerprompt}
>aspect();
>reset;
\end{eulerprompt}
...
>plot2d("x^2"):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-004.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^3-x"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-005.png}
\begin{eulerprompt}
>a:=5.6; plot2d("exp(-a*x^2)/a"); insimg(30); // menampilkan gambar hasil plot setinggi 25 baris
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-006.png}
\begin{eulercomment}
...
>plot2d("x^3-x",-1,2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-007.png}
\begin{eulerprompt}
>plot2d("sin(x)",-2*pi,2*pi): // plot sin(x) pada interval [-2pi, 2pi]
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-008.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(3*x)",xmin=0,xmax=2pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-009.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-010.png}
\begin{eulercomment}
...
>figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-011.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-012.png}
\begin{eulerprompt}
>plot2d("sin(x)+cos(2*x)",0,4pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-013.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-014.png}
\begin{eulerprompt}
>plot2d("x^x",r=1.2,cx=1,cy=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-015.png}
\begin{eulercomment}
...
>plot2d("log(x)",-0.1,2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-016.png}
\begin{eulercomment}
...
>plot2d("x^3-x",>square):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-017.png}
\begin{eulerprompt}
>plot2d(''integrate("sin(x)*exp(-x^2)",0,x)'',0,2): // plot integral
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-018.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-019.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-020.png}
\begin{eulerprompt}
>a:=5.6; expr &= exp(-a*x^2)/a; // define expression
>plot2d(expr,-2,2): // plot from -2 to 2
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-021.png}
\begin{eulerprompt}
>plot2d(expr,r=1,thickness=2): // plot in a square around (0,0)
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-022.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),>add,style="--",color=red): // add another plot
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-023.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x,2),a=-2,b=2,c=-2,d=1): // plot in rectangle
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-024.png}
\begin{eulerprompt}
>plot2d(&diff(expr,x),a=-2,b=2,>square): // keep plot square
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-025.png}
\begin{eulerprompt}
>plot2d("x^2",0,1,steps=1,color=red,n=10):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-026.png}
\begin{eulerprompt}
>plot2d("x^2",>add,steps=2,color=blue,n=10):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-027.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-028.png}
\begin{eulerprompt}
>plot2d("f",0,1;0.4): // plot with a=0.4
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-029.png}
\begin{eulerprompt}
>plot2d(\{\{"f",0.2\}\},0,1): // plot with a=0.2
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-030.png}
\begin{eulerprompt}
>plot2d(\{\{"f(x,b)",b=0.1\}\},0,1): // plot with 0.1
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-031.png}
\begin{eulerprompt}
>function f(x) := x^3-x; ...
>plot2d("f",r=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-032.png}
\begin{eulercomment}
...
>plot2d(f,0,2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-033.png}
\begin{eulercomment}
...
>plot2d(expr,0,3pi):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-034.png}
\begin{eulerprompt}
>function f(x) &= x^x;
>plot2d(f,r=1,cx=1,cy=1,color=blue,thickness=2);
>plot2d(&diff(f(x),x),>add,color=red,style="-.-"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-035.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-036.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-037.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{13}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-038.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-039.png}
\begin{eulerprompt}
>aspect(1.5); plot2d("sin(x)",0,2pi); plot2d("cos(x)",color=blue,style="--",>add):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-040.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-041.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-042.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-044.png}
\begin{eulercomment}
...
>insimg;
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-045.png}
\begin{eulercomment}
...
>plot2d(x,y):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-046.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-047.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-048.png}
\begin{eulerprompt}
>plot2d(["sin(x)","cos(x)"],0,2pi): // plot vector of expressions
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-049.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-050.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-051.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-052.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-053.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-054.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-055.png}
\begin{eulerprompt}
>expr := "log(x)/x"; ...
>  plot2d(expr,0.5,5,title="y="+expr,xl="x",yl="y"); ...
>  label("(1,0)",1,0); label("Max",E,expr(E),pos="lc"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-056.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-057.png}
\begin{eulercomment}
...
>tcolor=black,>left):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-058.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-059.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-060.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-061.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-062.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-063.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-064.png}
\begin{eulercomment}
...
>  x=0.7,y=0.2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-065.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-066.png}
\begin{eulerprompt}
>plot2d("exp(x)*sin(x)",user=true, ...
>  title="+/- or cursor keys (return to exit)"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-067.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-068.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-069.png}
\begin{eulercomment}
...
>plotf(nd):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-070.png}
\begin{eulercomment}
...
> figure(0):
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-071.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-072.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-073.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-074.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-075.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-076.png}
\begin{eulerprompt}
>plot2d(["exp(x)","1+x"],color=[black,blue],style=["-","-.-"]):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-077.png}
\begin{eulerprompt}
...
> reset():
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-078.png}
\begin{eulercomment}
...
> reset:
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-079.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-080.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-081.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-082.png}
\begin{eulerprompt}
>p=polyfit(xdata,ydata,1); // get regression line
>plot2d("polyval(p,x)",>add,color=red): // add plot of line
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-083.png}
...
>figure(0):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-084.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-085.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); ...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-086.png}
\begin{eulerprompt}
>t=linspace(0,2pi,6); plot2d(cos(t),sin(t),>filled,style="#"):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-087.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-088.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-089.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-090.png}
\begin{eulercomment}
...
> plot2d(t,t,add=true):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-091.png}
\begin{eulercomment}
...
>plot2d(t,y):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-092.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-093.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-094.png}
\begin{eulerprompt}
>plot2d("cos(x)","sin(x)^3",xmin=0,xmax=2pi,>filled,style="/"):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-095.png}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-096.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-097.png}
\begin{eulerprompt}
>t=linspace(0,1,1000); r=exp(-t); x=r*cos(2pi*t); y=r*sin(2pi*t);
>plot2d(x,y,r=1):
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-098.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-099.png}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-100.png}
\begin{eulerprompt}
>aspect(1.25); r=linspace(0,1,50); a=linspace(0,2pi,200)'; z=r*exp(I*a);
>plot2d(exp(z),cgrid=[40,10]):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-101.png}
\begin{eulerprompt}
>r=linspace(0,1,10); a=linspace(0,2pi,40)'; z=r*exp(I*a);
>plot2d(exp(z),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-102.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-103.png}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-104.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-105.png}
\begin{eulerprompt}
>columnsplot(cumsum(random(10)),style="/",color=blue):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-106.png}
\begin{eulercomment}
...
>title("Temperature"):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-107.png}
\begin{eulerprompt}
>k=0:10;
>plot2d(k,bin(10,k),>bar):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-108.png}
\begin{eulerprompt}
>plot2d(k,bin(10,k)); plot2d(k,bin(10,k),>points,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-109.png}
\begin{eulerprompt}
>plot2d(normal(1000),normal(1000),>points,grid=6,style=".."):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-110.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution,style="O"):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-111.png}
\begin{eulerprompt}
>plot2d("qnormal",0,5;2.5,0.5,>filled):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-112.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-113.png}
\begin{eulercomment}
...
>plot2d(x,y,>bar):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-114.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-115.png}
\begin{eulerprompt}
>n=10; i=0:n; ...
>plot2d(i,bin(n,i)/2^n,a=0,b=10,c=0,d=0.3); ...
>plot2d(i,bin(n,i)/2^n,points=true,style="ow",add=true,color=blue):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-116.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-117.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-118.png}
\begin{eulerprompt}
>k=0:10; m=bin(10,k); x=(0:11)-0.5; plot2d(x,m,>bar):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-119.png}
\begin{eulerprompt}
>columnsplot(m,k):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-120.png}
\begin{eulerprompt}
>plot2d(random(600)*6,histogram=6):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-121.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-122.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-123.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-124.png}
\begin{eulerprompt}
>plot2d(normal(1,1000),>distribution); ...
>  plot2d("qnormal(x)",color=red,thickness=2,>add):
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-125.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{21}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-126.png}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-127.png}
\begin{eulerprompt}
>expr := "2*x^2+x*y+3*y^4+y"; // define an expression f(x,y)
>plot2d(expr,level=0): // Solutions of f(x,y)=0
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-128.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,contourcolor=white,n=200): // nice
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-129.png}
\begin{eulerprompt}
>plot2d(expr,level=0:0.5:20,>hue,>spectral,n=200,grid=4): // nicer
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-130.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-131.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-132.png}
\begin{eulerprompt}
>plot2d("x^3-y^2",level=0,contourwidth=3,>add,contourcolor=red):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-133.png}
\begin{eulerprompt}
>z=z+normal(size(z))*0.2;
>plot2d(z,level=0.5,a=-1,b=2,c=-2,d=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-134.png}
\begin{eulerprompt}
>plot2d(expr,level=[0:0.2:5;0.05:0.2:5.05],color=lightgray):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-135.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=1,r=4,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-136.png}
\begin{eulerprompt}
>plot2d("x^2+2*y^2-x*y",level=0:0.1:10,n=100,contourcolor=white,>hue):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-137.png}
\begin{eulercomment}
...
>plot2d(expr,level=[0;1],style="-",color=blue): // 0 <= f(x,y) <= 1
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-138.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-139.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=[0,2,4;1,3,5],style="/",r=2,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-140.png}
\begin{eulerprompt}
>plot2d("x^2+y^3+x*y",level=-10:20,r=2,style="-",dl=0.1,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-141.png}
\begin{eulerprompt}
>plot2d("sin(x)*cos(y)",r=pi,>hue,>levels,n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-142.png}
\begin{eulercomment}
...
>  level=[-2;0],n=100):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-143.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-144.png}
\begin{eulerprompt}
...
\end{eulerprompt}
\eulerimg{27}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-145.png}
\begin{eulercomment}
...
>logimpulseplot1(x,y):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-146.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-147.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",0,100,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-148.png}
\begin{eulerprompt}
>plot2d("exp(x+sin(x))",10,100,logplot=2):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-149.png}
\begin{eulerprompt}
>plot2d("gamma(x)",1,10,logplot=1):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-150.png}
\begin{eulerprompt}
>plot2d("log(x*(2+sin(x/100)))",10,1000,logplot=3):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-151.png}
\begin{eulercomment}
...
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-152.png}
\begin{eulercomment}
\begin{eulercomment}
...
\end{eulerformula}
\begin{eulerprompt}
>aspect(3,4); plot2d(x^3): 
\end{eulerprompt}
\eulerimg{34}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-154.png}
\begin{eulercomment}
2. Gambarkan kurva\\
\end{eulercomment}
\begin{eulerformula}
...
\end{eulerformula}
\begin{eulerprompt}
>aspect(1.5); plot2d("x^2-2x"):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-156.png}
\begin{eulercomment}
3. Gambarkan kurva\\
\end{eulercomment}
\begin{eulerformula}
...
>plot2d(["x+1","2x-3"],-5,5):
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-158.png}
\begin{eulercomment}
4. Gambarkan kurva \\
\end{eulercomment}
\begin{eulerformula}
...
\end{eulerformula}
\begin{eulerprompt}
>plot2d("sin(x)"); insimg(20)
\end{eulerprompt}
\eulerimg{17}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-160.png}
\begin{eulercomment}
Diketahui fungsi\\
\end{eulercomment}
\begin{eulerformula}
...
\end{eulerformula}
\begin{eulercomment}
5. Gambarkan kurva dari fungsi b
\end{eulercomment}
\begin{eulerprompt}
>function a(x) := 2^x ;
>function b(x) := log(x) ;
>aspect(1.2); plot2d("b"):
\end{eulerprompt}
\eulerimg{22}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-163.png}
\begin{eulercomment}
6. Gambarkan kurva dari fungsi a
\end{eulercomment}
\begin{eulerprompt}
>plot2d("a",-2,5); insimg(15)
\end{eulerprompt}
\eulerimg{14}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-164.png}
\begin{eulercomment}
7. Gambarkan kurva\\
\end{eulercomment}
\begin{eulerformula}
...
\end{eulerformula}
\begin{eulerprompt}
>plot2d("x^3+y^2",r=1.5,level=[0;1],color=blue,style="/"):
\end{eulerprompt}
\eulerimg{22}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-166.png}
\begin{eulercomment}
8.
\end{eulercomment}
\begin{eulerprompt}
...
>plot2d(cos(t),sin(t),>filled,style="/",fillcolor=red,r=1.2):
\end{eulerprompt}
\eulerimg{22}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-167.png}
\begin{eulercomment}
9. Gambarkan kurva\\
\end{eulercomment}
\begin{eulerformula}
...
\end{eulerformula}
\begin{eulerprompt}
>plot2d("x^4-y^2",>contour,>hue,>spectral):
\end{eulerprompt}
\eulerimg{34}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-169.png}
\begin{eulercomment}
10. Gambarkan 5 diagram batang (random)
\end{eulercomment}
\begin{eulerprompt}
>aspect(1.2); columnsplot(cumsum(random(5)),style="/",color=green):
\end{eulerprompt}
\eulerimg{22}{images/EMT4Plot2D_Rifina Rizki Alfitasari_22305141047-170.png}
